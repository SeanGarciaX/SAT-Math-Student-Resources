...
# resources.py
#
# Plain data only - no HTML, no layout, no styling.
# Add or edit entries here to fill in placeholders in app.py.
# Any topic NOT listed below will keep showing its placeholder text.
#
# VIDEO_LINKS format:
#   "Topic Name": [
#       ("Video Title", "https://youtube.com/..."),
#       ("Another Video Title", "https://youtube.com/..."),
#   ]
...
VIDEO_LINKS = {
    ...
    "Quadratic Equations": [
        ...
        ("Quadratic Factored Form", "https://www.youtube.com/watch?v=pJjfJxX-aHs"),
